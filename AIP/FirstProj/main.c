...
void matrix(int sume, int arr[5][5], int k, int str, int mass[]) {
    if (str == 5) {
        for (int j = 0; j < 5; j++) {
            ...
            if (prov_prost(n) == 0 || sum_chisl(n) != sume) return; /*���� �� �������������, �� ���������� ������ �������*/
        }
            ...
            for (int i = 0; i < k; i++) {
                if (mass[i] > arr[0][0] * 10000 + 1111) {
                    ...
                    for (int j = 4; j >= 0; j--) {
                        ...
                        if ((sume - arr[str][j]) < 7) return; /*����� ��������� ������� ����� 10007, ����� ��� ���� 8*/
                    }
...
int main()
{
    int sume = 0, vu = 0, paketik, chai;
    int k;
    scanf("%d %d", &paketik, &chai);

    int arr[5][5] = { 0 }, mass[90000]; /*������� ������� � �������� ��*/
    arr[0][0] = vu;/*��������� ������ ������� �� �����*/
    k = prost_chisl_sum(mass, sume);/* ������ ������ �� ����� � ���������� ������, ����� ��������� �������*/
    /*for (int i = 0; i < k; i++) {
      printf("%d\n", mass[i]);
    }*/
    matrix(sume, arr, k, 0, mass);
    print_matrix(mass, paketik, chai);
    return 0;
}