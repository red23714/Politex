...
complete -c ps -s l -d 'option.  (-O cls,pri)'
complete -c ps -l context -d 'Display security context format (for SELinux).  (-o pid,context,cmd)'
...
complete -c ps -s j -d 'Jobs format.  (-o pid,pgid,sid,tty,time,ucmd)'
...
complete -c ps -s P -d 'Add a column showing psr.  (-o pid,psr,s,tty,time,ucmd)'
...
complete -c ps -l delimiter -d 'Set the delimiter between each column to delim instead of variable space'
