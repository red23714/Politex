...
complete -c usermod -s e -l expiredateEXPIRE_DATE -d 'Specifies the date on which the user account will be disabled'
complete -c usermod -s f -l inactiveINACTIVE -d 'Defines the number of days after a password exceeds its maximum age during wh…'
