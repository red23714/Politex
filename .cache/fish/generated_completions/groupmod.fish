...
complete -c groupmod -s a -l append -d 'If group members are specified with -U, append them to the existing member li…'
...
complete -c groupmod -s U -l users -d 'A comma-separated list of usernames to add as members of the group'
