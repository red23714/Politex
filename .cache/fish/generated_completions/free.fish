...
complete -c free -s L -l line -d 'Show output on a single line, often used with the  -s option to show memory s…'
...
complete -c free -s V -l version -d 'Display version information.  FILES'
