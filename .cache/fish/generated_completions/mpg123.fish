...
complete -c mpg123 -l loop -d 'for playing track(s) a certain number of times in a loop, < 0 means infinite …'
...
complete -c mpg123 -l reopen -d 'Forces reopen of the audiodevice after every track'
