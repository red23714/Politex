...
complete -c cec-ctl -s A -l list-devices -d 'List all cec devices'
...
complete -c cec-ctl -s x -l physical-address -d 'Show the physical address'
...
complete -c cec-ctl -l test-reliability -d 'This option tests the CEC reliability by transmitting <Give Physical Addr> up…'
complete -c cec-ctl -l test-standby-wakeup-cycle -d 'This option tests the standby-wakeup cycle behavior of the display'
complete -c cec-ctl -l stress-test-standby-wakeup-cycle -d 'This option performs a stress test for a display: it cycles the display <coun…'
complete -c cec-ctl -l stress-test-random-standby-wakeup-cycle -d 'This option performs a stress test for a display: it cycles the display <coun…'
