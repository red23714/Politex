...
complete -c portablectl -l no-reload -d 'Do not reload the service manager after attaching or detaching a portable ser…'
...
complete -c portablectl -l no-block -d 'Do not block waiting for attach --now to complete. sp Added in version 245'
complete -c portablectl -l clean -d 'When detaching ensure the configuration, state, logs, cache, and runtime data…'
