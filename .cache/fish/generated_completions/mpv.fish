...
complete -c mpv -l slang -d 'Analogous to --alang, for subtitle tracks. sp This is a string list option'
complete -c mpv -l vlang -d 'Analogous to --alang and --slang, for video tracks'
...
complete -c mpv -l script-opt -l script-opts -d 'Set options for scripts.  A script can query an option by key'
...
complete -c mpv -l ytdl-format -d 'Format selection string that is directly passed to youtube-dl'
...
complete -c mpv -l load-console -d 'Enable the built-in script to handle textual input (default: yes)'
complete -c mpv -l load-commands -d 'Enable the built-in script to enter commands in the console (default: yes)'
...
complete -c mpv -l load-context-menu -d 'Enable the builtin script that implements a context menu'
complete -c mpv -l load-positioning -d 'Enable the builtin script that provides various keybindings to pan videos and…'
complete -c mpv -l player-operation-mode -d 'For enabling "pseudo GUI mode", which means that the defaults for some option…'
complete -c mpv -l save-position-on-quit -d 'Always save the current playback position on quit, and also when the loadfile…'
...
complete -c mpv -l save-watch-history -d 'Whether to save which files are played'
complete -c mpv -l watch-history-path -d 'The path in which to store the watch history.  Default: ~~state/watch_history'
...
complete -c mpv -s 1 -d 'strictly prefer the container aspect ratio (deprecated, use --video-aspect-ov…'
...
complete -c mpv -l video-align-x -l video-align-y -d 'When the video is bigger than the window, these move the displayed rectangle …'
complete -c mpv -l video-recenter -d 'Whether to behave as if --video-align-x and --video-align-y were 0 when the v…'
...
complete -c mpv -l hwdec-threads -d 'Number of threads used for hardware decoding (default: 4)'
complete -c mpv -l hwdec-software-fallback -d 'Fallback to software decoding if the hardware-accelerated decoder fails (defa…'
...
complete -c mpv -l audio-exts -d 'Audio file extensions to try to match when using --audio-file-auto, --autocre…'
complete -c mpv -l audio-file-paths -d 'Analogous to --sub-file-paths option, but for auto-loaded audio files'
complete -c mpv -l audio-client-name -d 'The application name the player reports to the audio API'
complete -c mpv -l audio-set-media-role -d 'If enabled, mpv will set the appropriate media role on supported audio server…'
...
complete -c mpv -l sub-scale-signs -d 'When set to yes, also apply --sub-scale to typesetting (or "signs")'
...
complete -c mpv -l sub-hinting -d 'Set font hinting type.  <type> can be: NDENT 7. 0'
complete -c mpv -l sub-line-spacing -d 'Set line spacing value for SSA/ASS renderer'
complete -c mpv -l sub-shaper -d 'Set the text layout engine used by libass.  NDENT 7. 0'
complete -c mpv -l sub-ass-prune-delay -d 'Set the delay for automatic pruning of events from memory in libass'
complete -c mpv -l sub-glyph-limit -d 'Set the maximum number of cached glyphs in libass cache for the subtitle track'
complete -c mpv -l sub-bitmap-max-size -d 'Set the maximum bitmap cache size in libass cache for the subtitle track'
...
complete -c mpv -l image-subs-hdr-peak -d 'Controls the image subtitle diffuse white level in cd/mÂ² (nits) for HDR outp…'
complete -c mpv -l sub-hdr-peak -d 'Controls the text subtitle and OSD diffuse white level in cd/mÂ² (nits) for H…'
...
complete -c mpv -l sub-auto-exts -d 'Subtitle extensions to try and match when using --sub-auto'
...
complete -c mpv -l sub-fix-timing-threshold -d 'Set the threshold in milliseconds for fixing subtitle timing (default: 210)'
complete -c mpv -l sub-fix-timing-keep -d 'Set the minimum duration in milliseconds for subtitle events to be considered…'
...
complete -c mpv -l sub-filter-sdh-enclosures -d 'Specify pairs of characters that --sub-filter-sdh will use to potentially rem…'
...
complete -c mpv -l ontop-level -d '(macOS only) Sets the level of an on-top window (default: window).  NDENT 7'
...
complete -c mpv -l wid -o '1>' -d 'This tells mpv to attach to an existing window'
...
complete -c mpv -l cdda-device -d 'Specify the CD device for CDDA playback'
complete -c mpv -l dvd-device -d 'Specify the DVD device or . iso filename'
complete -c mpv -l bluray-device -d 'Specify the Blu-ray disc location'
...
complete -c mpv -l bluray-angle -d 'Some Blu-ray discs contain scenes that can be viewed from multiple angles'
...
complete -c mpv -l demuxer-mkv-crop-compat -d 'Enable compatibility mode for files that do not fully comply with the Matrosk…'
...
complete -c mpv -l input-tablet-emulate-mouse -d 'Emulate mouse move and button presses for tablet events (default: yes)'
complete -c mpv -l input-dragging-deadzone -d 'Begin the built-in window dragging when the mouse moves outside a deadzone of…'
complete -c mpv -l input-ime -d 'Enable keyboard input via an active input method (IME) connected to the VO'
...
complete -c mpv -l osd-font-size -d 'Specify the OSD font size.  See --sub-font-size for details. sp Default: 30'
...
complete -c mpv -l osd-bar-marker-scale -d 'Factor for the OSD bar marker size relative to the OSD bar outline size'
complete -c mpv -l osd-bar-marker-min-size -d 'Minimum OSD bar marker size. sp Default: 1. 6'
complete -c mpv -l osd-bar-marker-style -d 'Set the OSD bar marker style.  NDENT 7. 0'
...
complete -c mpv -l osd-selected-color -d 'The color of the selected item in lists.  See --sub-color for details'
complete -c mpv -l osd-selected-outline-color -d 'The outline color of the selected item in lists.  See --sub-color for details'
...
complete -c mpv -l osd-glyph-limit -d 'Set the maximum number of cached glyphs in libass cache for the OSD'
complete -c mpv -l osd-bitmap-max-size -d 'Set the maximum bitmap cache size in libass cache for the OSD'
complete -c mpv -l osd-prune-delay -d 'Set the delay for automatic pruning of events from memory in libass'
complete -c mpv -l osd-shaper -d 'Set the text layout engine used by libass for the OSD.  Default: complex'
...
complete -c mpv -l interpolation-threshold -d 'Threshold below which frame ratio interpolation gets disabled (default: 0'
...
complete -c mpv -l d3d11-output-mode -d 'Use a specific output mode for creating the D3D11 swapchain'
...
complete -c mpv -l wayland-internal-vsync -d 'Controls whether to use mpv\'s internal vsync for Wayland-base video outputs (…'
...
complete -c mpv -l macos-bundle-path -d 'App Bundles operate in their own shell environment that is different from the…'
complete -c mpv -l android-surface-size -d 'Set dimensions of the rendering surface used by the Android gpu context'
complete -c mpv -l d3d11-composition-size -d 'Set size of the output for d3d11 composition mode'
...
complete -c mpv -l target-colorspace-hint -d 'When enabled, output colorspace metadata will be set on the swapchain dependi…'
complete -c mpv -l target-colorspace-hint-mode -d 'Select which metadata to use for the --target-colorspace-hint'
complete -c mpv -l target-colorspace-hint-strict -d 'When enabled (default), the configured swapchain colorspace (with the hint) w…'
...
complete -c mpv -l hdr-reference-white -d 'Specifies the assumed peak brightness of the mastering display for SDR conten…'
complete -c mpv -l sdr-adjust-gamma -d 'SDR transfer functions are often ambiguous or mismatched'
complete -c mpv -l treat-srgb-as-power22 -d 'When enabled, sRGB is (de)linearized using a pure power 2'
...
complete -c mpv -l inverse-tone-mapping -d 'If set, allows inverse tone mapping (expanding dynamic range)'
...
complete -c mpv -l background-color -d 'Color used to draw parts of the mpv window not covered by video in --backgrou…'
complete -c mpv -l background-tile-color-0 -l background-tile-color-1 -d 'Colors used to draw parts of the mpv window not covered by video in --backgro…'
complete -c mpv -l background-tile-size -d 'Tile size used to draw parts of the mpv window not covered by video in --back…'
complete -c mpv -l border-background -d 'Same as --background but only applies to the black bar/border area of the win…'
complete -c mpv -l background-blur-radius -d 'The blur radius (in pixels) to use for --border-background=blur'
...
complete -c mpv -l image-exts -d 'Image file extensions to try to match when using --cover-art-auto, --autocrea…'
complete -c mpv -l cover-art-whitelist -d 'Filenames to load as cover art, sorted by descending priority'
complete -c mpv -l video-exts -d 'Video file extensions to try to match when using --autocreate-playlist or --d…'
complete -c mpv -l archive-exts -d 'Archive file extensions to try to match when using --autocreate-playlist or -…'
complete -c mpv -l playlist-exts -d 'Playlist file extensions to try to match when using --autocreate-playlist or …'
...
complete -c mpv -l clipboard-backends -d 'Specify a priority list of the clipboard backends to be used'
complete -c mpv -l clipboard-monitor -d 'Enable clipboard monitoring so that the clipboard property can be observed fo…'
complete -c mpv -l clipboard-xwayland -d 'Enable X11 clipboard backend in suspected Wayland environments (default: no)'
complete -c mpv -l register -d '(Windows only) (available also as mpv-register helper) '
complete -c mpv -l register-rpath -d '(Windows only) '
complete -c mpv -l unregister -d '(Windows only) (available also as mpv-unregister helper) '
...
complete -c mpv -o del -d 'T}	T{ Delete 1 or more items if present (same syntax as -set) T} _ T{'
...
complete -c mpv -l vo-kitty-auto-multiplexer-passthrough -d 'Automatically detect terminal multiplexer to passthrough escape sequences'
