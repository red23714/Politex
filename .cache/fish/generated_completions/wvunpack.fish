...
complete -c wvunpack -l no-overwrite -d 'Never overwrite, nor ask to overwrite, an existing file'
complete -c wvunpack -l normalize-floats -d 'normalize float audio to +/-1'
complete -c wvunpack -l no-threads -d 'force single-threaded operation, equivalent to -threads=1'
...
complete -c wvunpack -l threads -d 'Enable (or disable) multithreaded operation with n=1 (no threading) to n=12 (…'
