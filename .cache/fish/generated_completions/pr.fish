...
complete -c pr -o 'e[\\' -l expand-tabs -d 'expand input CHARs (TABs) to tab WIDTH (8)'
...
complete -c pr -o 'i[\\' -l output-tabs -d 'replace spaces with CHARs (TABs) to tab WIDTH (8)'
...
complete -c pr -o 'n[\\' -l number-lines -d 'number lines, use DIGITS (5) digits, then SEP (TAB), default counting starts …'
...
complete -c pr -o 's[\\' -l separator -d 'separate columns by a single character, default for CHAR is the <TAB> charact…'
complete -c pr -o 'S[\\' -l sep-string -d 'separate columns by STRING, without -S: Default separator <TAB> with -J and <…'
...
complete -c pr -s e -d 'expand input CHARs (TABs) to tab WIDTH (8)'
complete -c pr -s i -d 'replace spaces with CHARs (TABs) to tab WIDTH (8)'
complete -c pr -s n -d 'number lines, use DIGITS (5) digits, then SEP (TAB), default counting starts …'
complete -c pr -s s -d 'separate columns by a single character, default for CHAR is the <TAB> charact…'
complete -c pr -s S -d 'separate columns by STRING, without -S: Default separator <TAB> with -J and <…'
