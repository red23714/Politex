...
complete -c ruby -l backtrace-limit -d 'Limits the maximum length of backtraces to num lines (default -1, meaning no …'
...
complete -c ruby -s y
complete -c ruby -l yydebug -d 'This option is not guaranteed to be compatible.  Turns on compiler debug mode'
...
complete -c ruby -l crash-report -d 'Sets the template of path name to save crash report'
