...
complete -c mmcli -l help-cell-broadcast -d 'Show cell broadcast specific options.  is related'
...
complete -c mmcli -l cell-broadcast-status -d 'Show the status of the cell broadcast support'
complete -c mmcli -l cell-broadcast-list-cbm -d 'List cell broadcast messages available on a given modem'
complete -c mmcli -l cell-broadcast-delete-cbm -d 'Delete cell broadcast message at the given path or index'
complete -c mmcli -l cell-broadcast-set-channels -d 'Set the list of channels on which cell broadcasts are received (e. g'
