...
complete -c openvpn -l fast-io -d 'Optimize TUN/TAP/UDP I/O writes by avoiding a call to poll/epoll/select prior…'
...
complete -c openvpn -l tls-ciphers -l tls-ciphersuites -d 'These options are expert features, which - if used correctly - can improve th…'
