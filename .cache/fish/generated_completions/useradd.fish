...
complete -c useradd -s e -l expiredateEXPIRE_DATE -d 'Sets the date on which the user account will be disabled'
complete -c useradd -s f -l inactiveINACTIVE -d 'Defines the number of days after a password exceeds its maximum age before th…'
