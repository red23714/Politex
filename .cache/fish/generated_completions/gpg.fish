...
complete -c gpg -l enable-large-rsa -d 'TQ   --disable-large-rsa Enable the creation of RSA secret keys as large as 8…'
...
complete -c gpg -l openpgp -d 'Set all packet, cipher and digest options to OpenPGP compatible (RFC-9580) be…'
complete -c gpg -l rfc4880 -d 'Set all packet, cipher and digest options to strict RFC-4880 behavior'
complete -c gpg -l rfc4880bis -d 'This option is obsolete; it is handled as an alias for --gnupg'
complete -c gpg -l rfc2440 -d 'Set all packet, cipher and digest options to strict RFC-2440 behavior'
...
complete -c gpg -l disable-large-rsa -d 'Enable the creation of RSA secret keys as large as 8192 bit'
