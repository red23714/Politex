# qemu
# Autogenerated from man page /nix/store/h8l12ifl7rj8zw47haj76azabk1lplid-qemu-10.2.0/share/man/man1/qemu.1.gz
...
complete -c qemu -o netdev -d 'Configure a passt network backend which requires no administrator privilege t…'
complete -c qemu -o net -d 'Legacy option to configure or create an on-board (or machine default) Network…'
complete -c qemu -o chardev -d 'Backend is one of: null, socket, udp, msmouse, hub, vc, ringbuf, file, pipe, …'
...
complete -c qemu -o shim -d 'Use \'shim. efi\' to boot the kernel'
