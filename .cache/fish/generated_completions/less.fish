...
complete -c less -s W -l HILITE-UNREAD -d 'Like  "-w" "," but temporarily highlights the first new line after any forwar…'
...
complete -c less -l MOUSE -d 'Like  "--mouse" "," except the direction scrolled on mouse wheel movement is …'
