...
complete -c 'mkfs.btrfs' -l inode-flags -d 'Specify that path to have inode flags, other than the default one (which impl…'
complete -c 'mkfs.btrfs' -l reflink -d 'When used with --rootdir try to clone file extents using FICLONERANGE ioctl i…'
