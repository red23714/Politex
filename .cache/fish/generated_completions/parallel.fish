...
complete -c parallel -s N -d 'X Item "-N max-args" . PD Use at most max-args arguments per command line'
complete -c parallel -l nonall -d 'X Item "--nonall" --onall with no arguments'
complete -c parallel -l onall -d 'X Item "--onall" Run all the jobs on all computers given with --sshlogin'
