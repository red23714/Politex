...
complete -c widl -l oldtlb -d 'Generate a type library in the old format (SLTG format)'
complete -c widl -s u -d 'Generate a UUID file.  The default output filename is infile_i. c'
complete -c widl -l align -l packing -d 'Set the structure packing to n.  Supported values are 2, 4, and 8'
...
complete -c widl -o Oif -o Oic -o Oicf -d 'Generate new-style fully interpreted stubs.  This is the default'
...
complete -c widl -l winmd -d 'Generate a Windows Runtime Metadata file.  This implies the --winrt mode'
