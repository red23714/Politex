...
complete -c btrfs-scrub -s c -d 'set IO priority class (see ionice(1) %<https://man7'
complete -c btrfs-scrub -s n -d 'set IO priority classdata (see ionice(1) %<https://man7'
