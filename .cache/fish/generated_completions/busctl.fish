...
complete -c busctl -l json -d 'Shows output formatted as JSON'
complete -c busctl -s j -d 'Equivalent to --json=pretty if running on a terminal, and --json=short otherw…'
