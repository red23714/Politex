# qemu-nbd
# Autogenerated from man page /nix/store/h8l12ifl7rj8zw47haj76azabk1lplid-qemu-10.2.0/share/man/man8/qemu-nbd.8.gz
...
complete -c qemu-nbd -s t -l persistent -d 'Don\'t exit on the last connection'
...
complete -c qemu-nbd -l handshake-limit -d 'Set the timeout for a client to successfully complete its handshake to N seco…'
...
complete -c qemu-nbd -l pid-file -d 'Store the server\'s process ID in the given file'
