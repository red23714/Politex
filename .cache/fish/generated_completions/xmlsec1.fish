...
complete -c xmlsec1 -l list-key-data -d 'By default, all registered key data are enabled'
...
complete -c xmlsec1 -l hmac-min-out-len -d 'sets minimum HMAC output length to <bits>'
...
complete -c xmlsec1 -l output -d 'write result document to file <filename>; the <filename> can be a template an…'
...
complete -c xmlsec1 -l add-id-attr -d 'adds attribute <id-attribute-name> to all nodes in the document; this is a ha…'
complete -c xmlsec1 -l enabled-key-data -d 'comma-separated list of key-data types to enable.  Example:'
complete -c xmlsec1 -s '>'
complete -c xmlsec1 -l enabled-retrieval-method-uris -d 'comma separated list of of the following values: "empty", "same-doc", "local"…'
complete -c xmlsec1 -l enabled-key-info-reference-uris -d 'comma separated list of of the following values: "empty", "same-doc", "local"…'
...
complete -c xmlsec1 -l privkey-openssl-store -d 'load private key and certs through OpenSSL ossl_store interface (e. g'
...
complete -c xmlsec1 -l pubkey-openssl-store -d 'load pubkey key and certs through OpenSSL ossl_store interface (e. g'
complete -c xmlsec1 -l pubkey-openssl-engine -d 'load public key by OpenSSL ENGINE interface; specify the name of engine (like…'
complete -c xmlsec1 -l pwd -d 'the password to use for reading keys and certs'
complete -c xmlsec1 -l lax-key-search -d 'enable lax key search (e. g'
complete -c xmlsec1 -l verify-keys -d 'force verification of public/private keys loaded from the command: keys are r…'
complete -c xmlsec1 -l aes-key -d 'load AES key from binary file <file>'
complete -c xmlsec1 -l concatkdf-key -d 'load ConcatKDF key from binary file <file>'
complete -c xmlsec1 -l des-key -d 'load DES key from binary file <file>'
complete -c xmlsec1 -l hmac-key -d 'load HMAC key from binary file <file>'
complete -c xmlsec1 -l pbkdf2-key -d 'load Pbkdf2 key from binary file <file>'
...
complete -c xmlsec1 -l crl-pem -d 'load CRLs from PEM file <file>'
complete -c xmlsec1 -l crl-der -d 'load CRLs from DER file <file>'
...
complete -c xmlsec1 -l X509-skip-time-checks -d 'skip time checking of X509 certificates and CLRs'
...
complete -c xmlsec1 -l verbose -d 'print detailed error messages'
complete -c xmlsec1 -l print-crypto-library-errors -d 'print errors from crypto library (OpenSSL only)'
complete -c xmlsec1 -l repeat -d 'repeat the operation <number> times'
complete -c xmlsec1 -l base64-line-size -d 'sets the max line size for base64 encodings to <size>'
complete -c xmlsec1 -l transform-binary-chunk-size -d 'sets the transforms binary processing chunk size to <size>; increasing chunk …'
complete -c xmlsec1 -l xxe -d 'enable External Entity resolution'
complete -c xmlsec1 -l 'url-map:<url>' -d 'maps a given <url> to the given <file> for loading external resources'
