# qemu-img
# Autogenerated from man page /nix/store/h8l12ifl7rj8zw47haj76azabk1lplid-qemu-10.2.0/share/man/man1/qemu-img.1.gz
...
complete -c qemu-img -s c -d 'Indicates that target image must be compressed (qcow/qcow2 and vmdk with stre…'
...
complete -c qemu-img -s l -d 'Lists all snapshots in the given image (default action)'
...
complete -c qemu-img -s O -d 'Convert the disk image FILENAME or a snapshot SNAPSHOT_PARAM to disk image OU…'
complete -c qemu-img -s B -d 'Create the new disk image FILE of size SIZE and format FMT'
