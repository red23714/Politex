...
complete -c runc-checkpoint -l tcp-skip-in-flight -d 'Skip in-flight TCP connections'
complete -c runc-checkpoint -l link-remap -d 'Allow one to link unlinked files back when possible'
