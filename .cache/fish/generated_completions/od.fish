...
complete -c od -o 'w[\\' -l width -d 'output BYTES bytes per output line; 32 is implied when BYTES is not specified'
...
complete -c od -s w -d 'output BYTES bytes per output line; 32 is implied when BYTES is not specified'
