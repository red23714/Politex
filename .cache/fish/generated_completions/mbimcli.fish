...
complete -c mbimcli -l help-compal -d 'Show Compal Service options'
...
complete -c mbimcli -l query-register-state -d 'Query register state'
complete -c mbimcli -l set-register-state -d 'Set basic register settings (allowed keys: action, provider-id, data-class)'
...
complete -c mbimcli -l atds-query-location -d 'Query cell location'
complete -c mbimcli -l atds-query-operators -d 'Query operators'
complete -c mbimcli -l atds-query-rat -d 'Query Radio Access Technology . SS "Intel Firmware Update Service options:"'
...
complete -c mbimcli -l ms-set-lte-attach-configuration -d 'Set LTE attach configurations (groups separated by \'/\' if more than one, with…'
...
complete -c mbimcli -l quectel-set-radio-state -d 'Set radio state'
complete -c mbimcli -l quectel-set-command -d 'Send command to module (Command type is optional, defaults to AT, allowed opt…'
...
complete -c mbimcli -l sms-query-configuration -d 'Query SMS configuration'
complete -c mbimcli -l sms-query-message-store-status -d 'Query SMS message store status'
complete -c mbimcli -l sms-delete -d 'Delete all SMS matching a given filter'
complete -c mbimcli -l sms-read -d 'Read all SMS matching a given filter . SS "Compal options:"'
complete -c mbimcli -l compal-query-at-command -d 'send AT command to modem, and receive AT response '
