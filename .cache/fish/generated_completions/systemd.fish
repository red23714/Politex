...
complete -c systemd -l crash-action -d 'Specify what to do when the system manager (PID 1) crashes'
...
complete -c systemd -l no-pager -d 'is not given.  $SYSTEMD_PAGER is used if set; otherwise $PAGER is used'
