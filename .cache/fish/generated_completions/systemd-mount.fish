...
complete -c systemd-mount -l bind-device -d 'Controls whether the generated mount/automount unit shall be bound to the bac…'
...
complete -c systemd-mount -l canonicalize -d 'Controls whether the specified path shall be canonicalized on the client side…'
