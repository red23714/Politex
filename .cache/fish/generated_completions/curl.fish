...
complete -c curl -l silent -d 'VERSION This man page describes curl 8. 18. 0'
...
complete -c curl -l data-ascii -d '(HTTP) This option is just an alias for --data'
complete -c curl -s H
...
complete -c curl -s s -d 'Silent or quiet mode.  Do not show progress meter or error messages'
