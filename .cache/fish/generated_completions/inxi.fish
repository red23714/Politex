...
complete -c inxi -l output -d 'Change data output type.  Requires --output-file'
complete -c inxi -l output-file -d 'This is the file to write the output to.  The given directory path must exist'
