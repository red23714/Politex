...
complete -c cmake -l project-file -d 'Added in version 4. 0.  Specify an alternate project file name'
...
complete -c cmake -l graphviz -d 'Generate Graphviz %<https://www. graphviz. org/> of dependencies'
...
complete -c cmake -l log-context -d 'Enable the message() %<#command:message> command outputting context attached …'
complete -c cmake -l sarif-output -d 'Added in version 4. 0'
complete -c cmake -l debug-trycompile -d 'Do not delete the files and directories created for try_compile() %<#command:…'
...
complete -c cmake -l link-no-warning-as-error -d 'Added in version 4. 0'
complete -c cmake -l profiling-output -d 'Added in version 3. 18.  Used in conjunction with'
complete -c cmake -l profiling-format -d 'given path'
complete -c cmake -l preset -l preset -d 'Reads a preset %<#manual:cmake-presets(7)> from CMakePresets'
...
complete -c cmake -l prefix -d 'Override the installation prefix, CMAKE_INSTALL_PREFIX %<#variable:CMAKE_INST…'
...
complete -c cmake -l find-package -d 'It searches a package using the find_package() %<#command:find_package> comma…'
complete -c cmake -l workflow -d 'Select a Workflow Preset %<#workflow-preset> using one of the following optio…'
