...
complete -c pg_dumpall -l disable-triggers -d 'This option is relevant only when creating a dump with data and without schema'
...
complete -c pg_dumpall -l filter -d 'Specify a filename from which to read patterns for databases excluded from th…'
...
complete -c pg_dumpall -l no-comments -d 'Do not dump COMMENT commands'
complete -c pg_dumpall -l no-data -d 'Do not dump data'
complete -c pg_dumpall -l no-policies -d 'Do not dump row security policies'
...
complete -c pg_dumpall -l no-schema -d 'Do not dump schema (data definitions)'
complete -c pg_dumpall -l no-security-labels -d 'Do not dump security labels'
complete -c pg_dumpall -l no-statistics -d 'Do not dump statistics.  This is the default'
...
complete -c pg_dumpall -l statistics -d 'Dump statistics'
complete -c pg_dumpall -l statistics-only -d 'Dump only the statistics, not the schema (data definitions) or data'
complete -c pg_dumpall -l sequence-data -d 'Include sequence data in the dump'
