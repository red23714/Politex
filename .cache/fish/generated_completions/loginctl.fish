...
complete -c loginctl -l json -d 'Shows output formatted as JSON'
complete -c loginctl -s j -d 'Equivalent to --json=pretty if running on a terminal, and --json=short otherw…'
