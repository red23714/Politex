...
complete -c pdfsig -o assert-signer -d 'This option checks whether the signature covering the full document been made…'
complete -c pdfsig -o no-appearance -d 'Do not add appearance information when signing existing fields (signer name a…'
...
complete -c pdfsig -o enable-pgp -d 'Enable pgp signatures in the GnuPG backend.  Only available for GnuPG backend'
