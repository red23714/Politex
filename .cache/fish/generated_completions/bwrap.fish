...
complete -c bwrap -l symlink -d 'Create a symlink at DEST with target SRC. sp Since version 0. 9'
...
complete -c bwrap -l cap-add -d 'Add the specified capability CAP, e. g'
