...
complete -c yay -s N -l repo -d 'Assume all targets are from the repositories'
...
complete -c yay -o cc -d 'Remove unneeded dependencies, including packages optionally required by any o…'
