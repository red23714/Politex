...
complete -c host -s C -d 'This option indicates that named \\%<#\\:std-iscman-named> should check consist…'
complete -c host -s d -d 'This option prints debugging traces, and is equivalent to the -v verbose opti…'
complete -c host -s l -d 'This option tells named \\%<#\\:std-iscman-named> to list the zone, meaning the…'
...
complete -c host -s s -d 'This option tells named \\%<#\\:std-iscman-named> not to send the query to the …'
...
complete -c host -s W -d 'This options sets the length of the wait timeout, indicating that named \\%<#\\…'
