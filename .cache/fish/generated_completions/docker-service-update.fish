...
complete -c docker-service-update -l memory-swap -d '	Swap Bytes (-1 for unlimited)'
complete -c docker-service-update -l memory-swappiness -s 1 -d '	Tune memory swappiness (0-100), -1 to reset to default'
...
complete -c docker-service-update -s w -l workdir -d '	Working directory inside the container SEE ALSO docker-service(1)'
