...
complete -c createuser -s a -d 'Specifies an existing role that will be automatically added as a member of th…'
...
complete -c createuser -s g -d 'Specifies the new role should be automatically added as a member of the speci…'
...
complete -c createuser -s m -d 'Specifies an existing role that will be automatically added as a member of th…'
...
complete -c createuser -s v -d 'Set a date and time after which the role\\*(Aqs password is no longer valid'
complete -c createuser -o 'V
.br
--version' -d 'Print the createuser version and exit'
complete -c createuser -l bypassrls -d 'The new user will bypass every row-level security (RLS) policy'
complete -c createuser -l no-bypassrls -d 'The new user will not bypass row-level security (RLS) policies'
...
complete -c createuser -l with-admin
...
complete -c createuser -l member-of
...
complete -c createuser -l with-member
...
complete -c createuser -l valid-until
