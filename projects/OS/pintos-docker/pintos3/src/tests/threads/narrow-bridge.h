...
struct list emer_order;

struct list norm_order;

int cars_on_bridge;

enum car_direction current_dir;

int goida;
int emer_in_left_order;
int emer_in_right_order;

struct waiter_of_bridge {
