...
= Цель работы.
Оптимизировать курсовую работу прошлого семестра различными способами.

= Описание работы неоптимзирванной версии
Программа состоит из двух основных компонентов:

- qr_encoder.c --- генератор и архиватор цветных QR кодов имеет два режима работы:

+ Архивация:
#{
  set list(marker: [▶])
  [- Принимает строку данных и пароль для шифрования]
  []
}
+ Разархивация: 
