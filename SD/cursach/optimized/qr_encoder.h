...
int generate_qr_mem(char* original_string, char* password, uint8_t** out_ppm,
					size_t* out_size);
...
void extract_color_channels(const char* input_path, RGB*** red_channel,
							RGB*** green_channel, RGB*** blue_channel);
